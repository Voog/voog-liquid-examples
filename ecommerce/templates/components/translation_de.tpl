{
    ...
    "shared": {
      "mailers": {
        ...
        "order_details": {
          ...
          "customer_language": "Kundensprache",
          "date": "Datum",
          ...
          "instructions": "Lieferscheine",
          "invoice_for_order": "Rechnung für die Bestellung %{code}",
          "item": {
            "one": "1 Artikel",
            "other": "%{count} Artikel"
          },
  ...
  "mailers": {
    "common": {
      "delivered_to": "Von %{brand} an %{email} geliefert",
      "shop_powered_by": "Der Shop wird von %{brand} betrieben."
    }
  }
}